...
When you se that this service is up and running on `Visualizer` you should [remove](https://docs.docker.com/engine/reference/commandline/stack_rm/) this (`wordpress`) stack.
